...
contract ShareRewardPool
{
    ...
    uint256 public constant TOTAL_REWARDS = 9999 ether;

    uint256 public constant BLOCKS_PER_DAY = 28800; // 86400 / 3;
    uint256 public constant RUNNING_BLOCKS = 10512000; // 1 year = (86400/3) * 365

    uint256 public COIN_PER_BLOCK = 0.000951198630136986 ether; // 9999 ether / 10512000
    ...
    IERC20 public coin = IERC20(0xb0168Bca7dB2eFe53b9112c08aae36D744800645);
